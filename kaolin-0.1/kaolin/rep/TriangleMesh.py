...
class TriangleMesh(Mesh):
    ...
    def compute_vertex_normals(self):  # 点法向
    ...
    def compute_face_normals(self):  # 面法向
    ...
    def compute_edge_lengths(self):  # 计算edge长度
    ...
    def compute_face_areas(self):  # 计算face面积，在models.meshcnn这个代码里
        raise NotImplementedError

    def compute_interior_angles_per_edge(self):  # 计算每个edge的内角，在models.meshcnn这个代码里
        raise NotImplementedError

    def compute_dihedral_angles_per_edge(self):  # 计算二面角，在models.meshcnn这个代码里
        raise NotImplementedError
    ...
    def compute_adjacency_matrix_full(self):  # 计算邻接full矩阵
    ...
    def compute_adjacency_matrix_sparse(self):  # 计算邻接离散矩阵
