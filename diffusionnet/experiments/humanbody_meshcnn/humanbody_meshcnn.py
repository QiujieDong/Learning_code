...
from humanbody_meshcnn_dataset import HumanbodySegDataset
...
model_save_path = os.path.join(base_path, "data/saved_models/xyz_human_seg_{}_4x128.pth".format(input_features))
dataset_path = os.path.join(base_path, "data/humanbody_meshcnn")

# === Load datasets

# Load the test dataset
test_dataset = HumanbodySegDataset(dataset_path, train=False, k_eig=k_eig, use_cache=True, op_cache_dir=op_cache_dir)
test_loader = DataLoader(test_dataset, batch_size=None)

# Load the train dataset
if train:
    train_dataset = HumanbodySegDataset(dataset_path, train=True, k_eig=k_eig, use_cache=True,
...
if train:
    ...
    for epoch in range(n_epoch):
        ...
        test_acc = test()
        print("Epoch {} - Train overall: {:06.3f}%  Test overall: {:06.3f}%".format(epoch, 100 * train_acc,
                                                                                    100 * test_acc))
